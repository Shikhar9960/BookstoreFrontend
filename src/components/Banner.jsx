        ...
        <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
            <div className='order-2 md:order-1 w-full md:w-1/2 md:mt-24 mt-12'>
                <div className='space-y-12'>
                    ...
                    <p className='text-xl '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis dicta ab voluptates maxime sequi dolor cumque fuga eius excepturi. Sint reprehenderit aspernatur atque repudiandae eaque cum voluptate molestias, ipsam sunt.</p>
            ...
            <div className='order-1 w-full md:w-1/2 flex'>
                <img src={banner} alt="img" className='m-auto' />
            </div>
        </div>
    )
}
